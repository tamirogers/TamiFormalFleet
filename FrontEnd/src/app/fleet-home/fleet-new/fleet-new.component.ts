...
export class FleetNewComponent implements OnInit {
  ...
  onSubmit(form: NgForm) {
   ...
   /*  if (this.ClassTimesTeacherNameSelected == 'Select Teacher') {
      studentTime.ClassTimesTeacherNameSelected = null;
    } */
    ...
    console.log('posted ' + newAssignmentObject);
